...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 13, 2018 at 12:23 PM
...
(2, 'Rahim Saheb', 'rahim@gmail.com', '012522222', 'Naya Palton, Dhaka', 10000, 27100, 2500, '2018-10-13', '13368'),
(3, 'nazmul', 'naz@jhsgf', '55383453473', 'ghjghjghj', 2000, 1200, 0, '2018-10-14', '12535');
...
(1, '2', '700', '10', '2018', '2018-10-25', '13256', '', ''),
(2, '2', '400', '10', '2018', '2018-10-16', '24534', '', ''),
(3, '2', '500', '10', '2018', '2018-10-16', '24534', '', ''),
(4, '2', '', '', '', '', '', '2000.00', '24251');
...
(2, 2, 2, 2, 1, '5749', 'chocklet catebarry', '2018-10-04', 'One of the best chocklet in bangladesh', '450', '', '101', 'chocklet', '-1', 'Dhaka', 'chocklet', 'chocolates.jpg'),
...
(23, 3, '', '', '', 22, 2, '3000', 0, 0, 0, 19026, '19210');
...
(6, 6, 0, 26742, '5', '4600', '2018-11-05', '11', '2018', 2);
...
(1, 2, 5, '5', '2', '10', '2018', '2018-10-28', '400'),
...
(4, 2, '3', 24992, '2', '2018-10-09', '2018-10-25', '550', '98', '10', '49000', '2018', '2018-10-07', 1, 114),
(5, 1, '2', 20834, '3', '2018-10-07', '2018-10-20', '380', '247', '10', '494000', '2018', '2018-10-08', 1, 114),
...
(14, 2, '3', 27549, '10', '2018-11-07', '2018-11-21', '10000', '-10', '11', '-100000', '2018', '2018-11-10', 0, 0);
...
--
ALTER TABLE `customer_deposite`
  MODIFY `customer_deposite_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `distribution_packing`
  MODIFY `distribution_packing_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `import`
  MODIFY `import_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=121;

--
-- AUTO_INCREMENT for table `import_invoice`
--
ALTER TABLE `import_invoice`
  MODIFY `import_invoice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `product_history`
  MODIFY `product_history_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `sales_confirm`
  MODIFY `sales_confirm_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `sales_invoice`
  MODIFY `sales_invoice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `sales_report`
  MODIFY `sales_report_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `sales_return`
--
ALTER TABLE `sales_return`
  MODIFY `sales_return_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `supplier_packing`
  MODIFY `supplier_packing_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `unconfirmed_import`
--
ALTER TABLE `unconfirmed_import`
  MODIFY `unconfirmed_import_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `user_previledge`
  MODIFY `user_previledge_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
