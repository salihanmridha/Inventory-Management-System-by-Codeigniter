...
<h2>Supplier Wise Return Reports</h2>
            ...
            <div class="tab-content">
                <div class="tab-pane" id="v-home">
                    <div class="panel-body">
                        ...
                        <form action="<?php echo site_url('report/generate_return_supplier_wise_monthly_report'); ?>" role="form" class="form-horizontal form-groups-bordered"  method="post" enctype="multipart/form-data">
                ...
                <div class="tab-pane" id="v-profile">
                    <div class="panel-body">
                        ...
                        <form action="<?php echo site_url('report/generate_return_supplier_wise_yearly_report'); ?>" role="form" class="form-horizontal form-groups-bordered"  method="post" enctype="multipart/form-data">
                ...
                <form action="<?php echo site_url('report/generate_return_supplier_wise_custom_report');?>" role="form" class="form-horizontal form-groups-bordered"  method="post" enctype="multipart/form-data">
