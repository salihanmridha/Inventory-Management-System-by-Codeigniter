...
<h2>Invoice Wise Return Reports</h2>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane " id="invoice_wise_monthly">
                                <div class="panel-body">
                                    ...
                                    <form action="<?php echo site_url('report/generate_return_invoice_wise_monthly_report'); ?>" role="form" class="form-horizontal form-groups-bordered"  method="post" enctype="multipart/form-data">
                            ...
                            <div class="tab-pane" id="invoice_wise_yearly">
                                <div class="panel-body">
                                    ...
                                    <form action="<?php echo site_url('report/generate_return_invoice_wise_yearly_report'); ?>" role="form" class="form-horizontal form-groups-bordered"  method="post" enctype="multipart/form-data">
                            ...
                            <div class="tab-pane" id="invoice_wise_custom">
                                <div class="panel-body">
                                    ...
                                    <form action="<?php echo site_url('report/generate_return_invoice_wise_custom_report'); ?>" role="form" class="form-horizontal form-groups-bordered"  method="post" enctype="multipart/form-data">
