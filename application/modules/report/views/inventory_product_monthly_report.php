...
<h2>Generate Your Inventory Report</h2>
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form action="<?php echo site_url('report/generate_inventory_product_monthly_report');?>" role="form" class="form-horizontal form-groups-bordered"  method="post" enctype="multipart/form-data">
