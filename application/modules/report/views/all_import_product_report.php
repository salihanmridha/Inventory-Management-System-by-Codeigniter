            ...
            <div class="tab-content">
                <div class="tab-pane" id="v-home">
                    <div class="panel-body">
                        ...
                        <form action="<?php echo site_url('report/generate_all_purchase_report_monthly'); ?>" role="form" class="form-horizontal form-groups-bordered"  method="post" enctype="multipart/form-data">
                ...
                <div class="tab-pane" id="v-profile">
                    <div class="panel-body">
                        ...
                        <form action="<?php echo site_url('report/generate_all_purchase_report_yearly'); ?>" role="form" class="form-horizontal form-groups-bordered"  method="post" enctype="multipart/form-data">
                ...
                <form action="<?php echo site_url('report/generate_all_purchase_report_custom');?>" role="form" class="form-horizontal form-groups-bordered"  method="post" enctype="multipart/form-data">
