...
<div class="col-xs-12 " style=" margin-top: 10px; text-align: center; margin-bottom: 8px;">

            <label>Purchase Report</label> (Supplier Wise)
            <br>
            <b style="color:red;"><?php echo $from ?> To <?php echo $to ?> - 2018</b>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 invoice-left" style="margin-top: 10px;">
