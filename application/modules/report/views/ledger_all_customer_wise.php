...
<h2>All Customer Ledger Reports</h2>
            ...
            <div class="tab-content">
                <div class="tab-pane" id="v-home">
                    <div class="panel-body">
                        ...
                        <form action="<?php echo site_url('report/generate_ledger_all_customer_wise_monthly'); ?>" role="form" class="form-horizontal form-groups-bordered"  method="post" enctype="multipart/form-data">
                ...
                <div class="tab-pane" id="v-profile">
                    <div class="panel-body">
                        ...
                        <form action="<?php echo site_url('report/generate_ledger_all_customer_wise_yearly'); ?>" role="form" class="form-horizontal form-groups-bordered"  method="post" enctype="multipart/form-data">
                ...
                <div class="tab-pane" id="v-messages">
                    <div class="panel-body">
                        ...
                        <form action="<?php echo site_url('report/generate_ledger_all_customer_wise_custom'); ?>" role="form" class="form-horizontal form-groups-bordered"  method="post" enctype="multipart/form-data">
