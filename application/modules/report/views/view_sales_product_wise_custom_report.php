...
<div class="invoice" id="invoice_print" >
    ...
    <div class="row">
        ...
        <div class="col-xs-12 " style="margin-top: 10px;text-align: center">
            ...
            <label> Sales Report</label> (Product Wise)
            <br>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 invoice-left" style="margin-top: -26px;">
            ...
            <?php foreach ($product as $r) { ?>
                <b>Product Name:</b> <?php echo $r['product_name'] ?>-<?php echo $r['brand_name']?>-<?php echo $r['unit_name'] ?>
                <br />
                <b>Code No:</b> <?php echo $r['product_code_no'] ?>
    ...
    <table class="table table-bordered" style="margin-top: -28px;">
        <thead>
            <tr>
                ...
                <th class="text-right " style="border:1px solid black !important;font-weight: bold;color:black">TOTAL Price (BDT)</th>
            </tr>
        </thead>
        ...
        <div class="col-xs-12">
            <div class="col-xs-8">
                ...
                <div class="invoice-left">
                    ...
                    <b> In Words: Taka <?php echo $this->numbertowords->convert_number($grand_total); ?></b>
