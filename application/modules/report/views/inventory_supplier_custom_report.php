        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-heading">
                <div class="panel-title" >
                    <b>Custome Period Inventory Report</b>
                </div>
            ...
            <div class="panel-body">
                ...
                <form action="<?php echo site_url('report/generate_inventory_supplier_custom_report');?>" role="form" class="form-horizontal form-groups-bordered"  method="post" enctype="multipart/form-data">
