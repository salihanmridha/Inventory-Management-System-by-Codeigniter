...
<h2>Product Wise Return Reports</h2>
            ...
            <div class="tab-content">
                <div class="tab-pane" id="v-home">
                    <div class="panel-body">
                        ...
                        <form action="<?php echo site_url('report/generate_return_product_wise_monthly_report'); ?>" role="form" class="form-horizontal form-groups-bordered"  method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-5"> 
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <select  name="product_id" class="select2" data-allow-clear="true" data-placeholder=" Product..." required="">
                ...
                <div class="tab-pane" id="v-profile">
                    <div class="panel-body">
                        ...
                        <form action="<?php echo site_url('report/generate_return_product_wise_yearly_report'); ?>" role="form" class="form-horizontal form-groups-bordered"  method="post" enctype="multipart/form-data">
                ...
                <form action="<?php echo site_url('report/generate_return_product_wise_custom_report');?>" role="form" class="form-horizontal form-groups-bordered"  method="post" enctype="multipart/form-data">
