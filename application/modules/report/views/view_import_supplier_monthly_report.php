...
<div class="invoice" id="invoice_print" >
    ...
    <div class="row">
        ...
        <div class="col-xs-12" style="margin-top: 10px;text-align: center; font-size: 13px;">

            <label>Monthly Purchase Report</label> (Supplier Wise)
            <br>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 invoice-left" style="margin-top: -26px;">
            ...
            <?php foreach ($supplier as $r) { ?>
                ...
                <br />
                <b>Email:</b> <?php echo $r['supplier_email'] ?>
                <br />
                <b>Phone:</b> <?php echo $r['supplier_phone'] ?>
                <br />
                <b>Address:</b> <?php echo $r['supplier_address'] ?>
    ...
    <table class="table table-bordered" style="margin-top: -28px;">
        ...
        <tbody style="padding: 0px !important;">
            ...
            foreach ($monthly_report as $r) {
                ?>
                <tr>
                    <td style="width: 2%; border: 1px solid;" class="text-center" style="border:1px solid black !important;"><?php echo $row_count ?></td>

                    <td style="width: 5%; border: 1px solid;" class="text-center" style="border:1px solid black !important;"><?php echo $r['import_code_no'] ?></td>

                    <td style="width: 8%; border: 1px solid;" class="text-center" style="border:1px solid black !important;"><?php echo $r['import_date'] ?></td>

                    <td style="width: 10%; border: 1px solid;" class="text-center" style="border:1px solid black !important;"><?php echo $r['product_code_no'] ?></td>

                    <td style="width: 10%;" style="width: 10%;" class="text-center" style="border:1px solid black !important;"><?php echo $r['product_name'] ?>-<?php echo $r['brand_name'] ?>-<?php echo $r['style_name'] ?> </td>

                    <td style="width: 10%;" class="text-left" style="border:1px solid black !important;"><?php echo $r['production_date'] ?></td>

                     <td style="width: 10%;" class="text-center" style="border:1px solid black !important;"><?php echo $r['expiery_date'] ?></td>

                    <td style="width: 10%;" class="text-left" style="border:1px solid black !important;"><?php echo $r['supplier_product_unit'] ?></td>

                    <td style="width: 10%;" class="text-center" style="border:1px solid black !important;"><?php echo $r['quantity'] ?></td>
            ...
            <tr>
              ...
              <td>Total Qty:</td>
              <td colspan="3">
                <strong > <?php echo $grand_total_qty; ?></strong>
              </td>
            </tr>
        </tbody>
    </table>
    ...
    <div class="row" style="margin-top: -18px;">
        <div class="col-xs-12">
            ...
            <div class="col-xs-4 " style="padding-left: 85px;">
