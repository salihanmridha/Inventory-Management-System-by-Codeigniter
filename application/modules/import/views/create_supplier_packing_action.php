...
<h2>Add Supplier Packing Info</h2>
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body" >
                <form action="<?php echo site_url('import/get_product_import_supplier'); ?>" role="form" class="form-horizontal form-groups-bordered"  method="post" enctype="multipart/form-data">
                    <div class="col-md-12">
                        <div class="col-md-6">
                ...
                <?php foreach ($product_info as $r) { ?>
                    ...
                    if ($r['product_id'] == '') {
                        ...
                        <form style="display: none" action="<?php echo site_url('import/insert_supplier_packing'); ?>" role="form" class="form-horizontal form-groups-bordered"  method="post" enctype="multipart/form-data">
                    ...
                    <?php
                        ...
                        <form  action="<?php echo site_url('import/insert_supplier_packing'); ?>" role="form" class="form-horizontal form-groups-bordered"  method="post" enctype="multipart/form-data">
                            <div class="col-md-12" id="initial" >
                                <div class="col-md-6">
                                    <input type="hidden" name="product_id" value="<?php echo $r['product_id'] ?>">
                                    <input  name="supplier_id" type="hidden"  value="<?php echo $r['supplier_id'] ?>">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input  name="supplier_product_unit" type="text" class="form-control" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input  name="supplier_product_quantity" type="text" class="form-control" >
                                               
                                        </div>
                                    </div>
                            </div>

                            <div class="form-group col-sm-12" style="text-align: center;margin-top: 23px;margin-left: 33px;">
                                <button style="width:100px;height:35px;font-size:15px;text-align: center"  type="submit" class="btn btn-success">Packing</button>	
                            </div>
                        </form>
