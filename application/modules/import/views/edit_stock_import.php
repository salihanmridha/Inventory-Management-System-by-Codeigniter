...
<h2>Update Product Info (Initial Import From Stock)</h2>
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                <?php foreach ($import_stock as $r) { ?>
                    <form action="<?php echo site_url('import/update_stock_import'); ?>/<?php echo $r['import_id'] ?>" role="form" class="form-horizontal form-groups-bordered"  method="post" enctype="multipart/form-data">
